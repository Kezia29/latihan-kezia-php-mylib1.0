                      ...
                      <td>
                        <div class="btn=group pr-0">
                          <button type ="button" class="btn btn-info btn-xs">
                            <a class="text-light" href="input-member.php?id_member=<?php echo $row['id_member'] ?>">
                            Edit
                          </a>
                          </button>
                          <button type="button" class="btn btn-danger btn-xs">
                            <a class="text-light" href="controller/delete-member.php?id_member=<?php echo $row['id_member'] ?>">
                                  Delete
                            </a>
                          </button>
                        </div>
