...
$db->query('SELECT * FROM librarians');
$hasil = $db->get();
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data Librarians</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Librarians</a></li>
              <li class="breadcrumb-item active">Data Librarians</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">List of Librarians</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
              <!-- <div class="row">
              ...
              <table id="example1" class="table table-bordered table-striped">
                  ...
                  ?>
                    ...
                    <tr>
                      <td>
                        <img style="width: 50px; height: auto;" src="<?= 'data:image/jpeg;base64,' . $row['avatar'] ?>" alt ="cover"></td>
                      <td><?=$row['username'] ?></td>
                      <td><?=$row['name'] ?></td>
                      <td><?=$row['division'] ?></td>
                      <td>
                        <div class="btn=group pr-0">
                          <button type ="button" class="btn btn-info btn-xs">
                            <a class="text-light" href="input-admin.php?username=<?php echo $row['username'] ?>">
                            Edit
                          </a>
                          </button>
                          <button type="button" class="btn btn-danger btn-xs">
                            <a class="text-light" href="controller/delete-librarians.php?username=<?php echo $row['username'] ?>">
                                  Delete
                            </a>
                          </button>
                        </div>
